...
std::array<GenricDictionaryDataPair<TestFunctionalityEnumDict, std::string>, 17>
copyVecToArray(
    std::vector<GenricDictionaryDataPair<TestFunctionalityEnumDict, std::string>>& testVec
)
{
